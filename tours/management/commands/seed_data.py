...
#     help = 'Seed 300+ tours with unique titles, images, participants, offers, guides, and coordinates'
#
...
#             self.stdout.write(self.style.ERROR("Need users for each role"))
#             return
#
...
#                 ptr += 1
#
#                 start = fake.date_between(start_date='-120d', end_date='+120d')
...
#                     cost_per_person=round(random.uniform(200, 5000), 2),
...
#                     tour.guides.add(g)
#
#                 tourists_sample = random.sample(tourists, random.randint(6, min(15, len(tourists))))
#                 for u in tourists_sample:
#                     TourParticipant.objects.create(
#                         tour=tour, user=u,
#                         joined_at=fake.date_time_between(start_date=start - timedelta(days=60), end_date=start)
#                     )
#
#                 for __ in range(random.randint(1, 3)):
#                     vfrom = start - timedelta(days=random.randint(10, 25))
#                     vuntil = start - timedelta(days=random.randint(2, 8))
...
#                     )
#
#         self.stdout.write(self.style.SUCCESS(f"✅ Seeded {total_tours} tours with unique destinations"))
